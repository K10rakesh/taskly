...
async function removeManagedLabels(octokit, apiContext, existingLabels, managedLabels) {
...
async function applySelectedLabel(octokit, apiContext, selectedLabel) {
  if (!selectedLabel) {
...
async function applyLabel() {
  try {
    ...
    const source = mode === "issue" ? payload.title : payload.head.ref;
